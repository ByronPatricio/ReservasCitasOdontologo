	...
	public function VerPerfilSecretariaC(){
		...
		echo '<tr>
				...
				if($resultado["foto"] != ""){
					...
					echo '<td><img src="http://localhost/ReservasCDental/'.$resultado["foto"].'" class="img-responsive" width="40px"></td>';

				}else{

					echo '<td><img src="http://localhost/ReservasCDental/Vistas/img/defecto.png" class="img-responsive" width="40px"></td>';
				...
				echo '<td>
					...
					<a href="http://localhost/ReservasCDental/perfil-S/'.$resultado["id"].'">
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						...
						if($resultado["foto"] == ""){
							...
							echo '<img src="http://localhost/ReservasCDental/Vistas/img/defecto.png" width="200px;">';

						}else{

							echo '<img src="http://localhost/ReservasCDental/'.$resultado["foto"].'" width="200px;">';
	...
	public function ActualizarPerfilSecretariaC(){
		...
		if(isset($_POST["idP"])){
			...
			if($resultado == true){
				...
				window.location = "http://localhost/ReservasCDental/perfil-S/'.$_SESSION["id"].'";
				</script>';
