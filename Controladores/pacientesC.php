	...
	public function VerPerfilPacienteC(){
		...
		echo '<tr>
				...
				<td>
					...
					<a href="http://localhost/ReservasCDental/perfil-P/'.$resultado["id"].'">
					...
					<div class="row">
						...
						<div class="col-md-6 col-xs-12">
							...
							if($resultado["foto"] != ""){
								...
								echo '<img src="http://localhost/ReservasCDental/'.$resultado["foto"].'" width="200px" class="img-responsive">';

							}else {

								echo '<img src="http://localhost/ReservasCDental/Vistas/img/defecto.png" width="200px" class="img-responsive">';
	...
	public function ActualizarPerfilPacienteC(){
		...
		if(isset($_POST["Pid"])){
			...
			if($resultado == true){
				...
				window.location = "http://localhost//ReservasCDental/perfil-P/'.$_SESSION["id"].'";
				</script>';
